...
template <typename T>
class LinearInterpRevOp : public OpKernel {
 public:
  explicit LinearInterpRevOp(OpKernelConstruction* context) : OpKernel(context) {}
...
#define REGISTER_KERNEL(type)                                              \
  REGISTER_KERNEL_BUILDER(                                                 \
      Name("LinearInterpRev").Device(DEVICE_CPU).TypeConstraint<type>("T"),\
      LinearInterpRevOp<type>)
